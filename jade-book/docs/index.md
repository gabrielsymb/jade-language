...
features:
  ...
  - icon: ⚡
    ...
    details: Seu código roda no browser e no Node.js com performance próxima ao nativo. Um compilador, dois ambientes.

  - icon: 🏢
    title: Feito para sistemas empresariais
    details: Entidades, serviços, eventos, regras de negócio — os blocos de construção de sistemas reais estão na linguagem, não em bibliotecas externas.
  ...
  - icon: 🔒
    ...
    details: O compilador detecta erros de tipo, campos obrigatórios ausentes, ciclos de eventos e outros problemas antes do código rodar.
